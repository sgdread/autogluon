...
class AbstractTrainer:
    ...
    def __init__(self, path: str, problem_type: str, scheduler_options=None, objective_func=None, stopping_metric=None,
                 ...
                 stack_ensemble_levels=0, time_limit=None, save_data=False, verbosity=2, callbacks_manager=None):
        self.path = path
        ...
        if self.bagged_mode:
            ...
            models = [
                stacker_type(path=self.path, name=model.name + '_STACKER_l' + str(level), model_base=model, base_model_names=base_model_names,
                                     ...
                                     num_classes=self.num_classes, random_state=level, callbacks_manager=self.callbacks_manager)
                for model in models]
